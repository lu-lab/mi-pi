...
imagingSettings_json = json.dumps([
    ...
    {'type': 'string',
     'title': 'LED mode',
     'desc': 'options are darkfield, brightfield, RGB pie, RGB donut, or RGB dots (if you select dark or brightfield, fill out the remaining settings)',
     'section': 'LED matrix',
     'key': 'ledmode'},
    {'type': 'string',
     'title': 'LED color',
    ...
    {'type': 'numeric',
     'title': 'timelapse image frequency',
     'desc': 'in seconds',
     'section': 'LED matrix',
...
imageProcessingSettings_json = json.dumps([
    ...
    {'type': 'options',
     ...
     'options': ['None', 'image delta', 'neural net']},
    {'type': 'bool',
    ...
    {'type': 'bool',
     ...
     'key': 'nn_count_eggs'},
    {'type': 'numeric',
     'title': 'threshold distance for LED illumination',
     'desc': 'worm centroid movement greater than this many pixels prevents LED stimulation',
     'section': 'neural net',
     'key': 'nn_distance_thresh'},
